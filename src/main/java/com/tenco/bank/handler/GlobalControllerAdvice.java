...
public class GlobalControllerAdvice {
	...
	// 단. @ControllerAdvice를 사용하고 있다면 @ResponseBody 를 붙여서 사용하면 된다.
	@ResponseBody
	...
	@ResponseBody
	@ExceptionHandler (UnAuthorizedException.class)  // UnAuthorizedException가 발생하면 메소드 작동
	public String unAutorizedException(UnAuthorizedException e) {
		StringBuffer sb = new StringBuffer();
		sb.append(" <script>");
		sb.append(" alert('"+ e.getMessage() +"');");
